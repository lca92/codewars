...
// My reasoning:
// 1. Let's iterate while n is bigger than 0. To avoid an infinite loop, we add n-- at the end. It will decrease the value of n by 1 after each iteration until it reaches 0.
// 2. But, while it's still bigger than 0, let's check if the remainder (%) of n divided by 2 is 1 or 0. Why? Because of the ternary operator syntax.
// 3. The syntax is: "condition ? exprIfTrue : exprIfFalse". Since 1 evaluates as true and 0 evaluates as false, what we're doing here is switching sides of the string with each iteration.
